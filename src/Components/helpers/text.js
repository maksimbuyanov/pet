    ...
    choice: {
      ...
      cardsArr: [
        ...
        },
        {
          ...
          gradient: "green",
          title: БОЛ_КР_ЛИНИЯ,
          listItems: `Большая кофейня - больше посетителей! Шикарное двух-этажное 
    ...
    choice: {
      ...
      cardsArr: [
        ...
        },
        {
          ...
          gradient: "blue",
          title: СТАНДАРТ,
          listItems: `Стандартный набор. Минимум мебели, большая стойка, надежная 
          кофемашина.`,
        },
        {
          cost: 1300000,
          ...
          магазина. Гость должен сразу понять, что тут подается лучший кофе.`,
        },
      ],
    },
  },
...
export const userActions = [
  {
    ...
    effect: `Увеличит количество посетителей, конверсию в покупку, колличество 
    покупок на одного клиента. Но уменьшит средний чек`,
    text: `Ура, покупателей стало еще больше. Твоя кофейня пользуется еще 
  ...
  },
  {
    ...
    text: `Теперь твой божественный кофе могут попробовать даже в самом далеком 
    уголке города без отрыва от работы или домашних дел.`,
  },
  {
    title: "Увеличить штат сотрудников",
    cost: 50000, // TODO стоимость шага
    visitors: 2000,
    salary: 50000, // TODO проверить что бы не списывалась два раза
    effect: `Увеличит количество посетителей и расходы на зарплату сотрудникам. Цена 50 000 руб.`,
    text: `Один бариста хорошо, а два еще лучше. Но помни, чем больше штат, тем 
    больше расходы`,
  },
  {
    ...
    рекламой на каждом углу и теперь о твое кафе знает каждый.`,
  },
  {
    ...
    text: `Вся молодеж сейчас в сети, а это 83% твоей целевой аудитории. 
    Пара платных постов в соц.сетях и таргетинг делают свое дело, посетителей 
  ...
  },
  {
    ...
    одного взгляда на твое меню. Что будешь делать дальше?`,
  },
  {
    ...
    клиентам!  Потрясающая новогодняя атмосфера в кофейне привекают еще больше 
    гостей`,
  },
  {
  ...
  },
  {
    ...
    effect: `Иногда нужно отпутить ситуацию посмотреть как все будет работать без тебя.`,
    text: `Пускать все на самотек долго нельзя. Бизнес - дело для активных. Уже 
...
export const blackGeese = [
  ...
  },
  {
    ...
    visitors: 2000,
    avPrice: -20,
    text: `Ты "сорвал джек-пот", рядом открылся Университет и теперь все зависит 
  ...
  },
  {
    ...
    качество, цену и разнообразие. Подумай, что еще можно сделать в этой борьбе?`,
  },
  {
